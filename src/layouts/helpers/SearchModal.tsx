...
const SearchModal = () => {
  ...
  const searchResult = useMemo(() => {
    ...
    return { items, time: ((endTime - startTime) / 1000).toFixed(3) };
  }, [searchString]);
  ...
  useEffect(() => {
    ...
    if (!searchModal || !searchInput || !searchModalOverlay) return;
    ...
    const handleKeydown = (event: KeyboardEvent) => {
      ...
      if (!searchModal!.classList.contains("show")) return;
  ...
  return (
    <div id="searchModal" className="search-modal">
      ...
      <div className="search-wrapper">
          ...
          >
            ...
            {searchString ? (
              <svg
                ...
                height="18"
                width="18"
                className="hover:text-red-500 -mt-0.5 cursor-pointer"
              >
        ...
        <SearchResult searchResult={searchResult.items} searchString={searchString} />
        <div className="search-wrapper-footer">
          ...
          {searchString && (
            <span>
              ...
              <strong>{searchResult.time} </strong> seconds
            </span>
          )}
          <span>
